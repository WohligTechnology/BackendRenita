var jsArray = [
  ...
  "https://cdnjs.cloudflare.com/ajax/libs/tinymce/4.6.5/tinymce.min.js",
  "https://cdnjs.cloudflare.com/ajax/libs/tinymce/4.6.5/themes/inlite/theme.min.js",
...
gulp.task('production', gulpSequence(["copy:img", "copy:pageJson", "copy:fonts", "sass:production", "minify:indexproduction", "minify:views"], 'clean:tmp', "concat:js", 'clean:tmp', "templatecache", "uglify:js", "minify:css", 'clean:tmp', 'clean:tmp', "copy:indexhtml", "copy:wjs", "copy:wcss", 'clean:tmp', 'clean:tmp', "zip"));